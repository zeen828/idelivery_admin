...
class CreateOfferQtyMenuGroupN extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('offer_qty_menu_group_n', function (Blueprint $table) {
        ...
        DB::statement("ALTER TABLE `offer_qty_menu_group_n` comment '那些商品第幾件多少錢'");
    }
    ...
    {
        Schema::dropIfExists('offer_qty_menu_group_n');
    }
}
