...
class CreateOfferDiscountMenuItemN extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('offer_discount_menu_item_n', function (Blueprint $table) {
        ...
        DB::statement("ALTER TABLE `offer_discount_menu_item_n` comment '那些商品同品項第幾件金額打折'");
    }
    ...
    {
        Schema::dropIfExists('offer_discount_menu_item_n');
    }
}
