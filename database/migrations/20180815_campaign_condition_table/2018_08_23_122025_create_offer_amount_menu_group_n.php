...
class CreateOfferAmountMenuGroupN extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('offer_amount_menu_group_n', function (Blueprint $table) {
        ...
        DB::statement("ALTER TABLE `offer_amount_menu_group_n` comment '那些商品第幾件金額折扣多少錢'");
    }
    ...
    {
        Schema::dropIfExists('offer_amount_menu_group_n');
    }
}
