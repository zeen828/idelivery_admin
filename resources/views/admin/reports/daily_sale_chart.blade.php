<div class="box">
    <div class="box-header">
        <h3 class="box-title">日期銷售統計報表</h3>
    </div>
    <div class="box-body table-responsive no-padding" style="border-top: 1px solid #f4f4f4;">
        <div id="daily_sale" style="min-width: 250px; height: 400px; margin: 0 auto; padding: 10px;"></div>
    </div>
...
<script>
    ...
    $( document ).ready(function() {
        var chartData = null;
        var chartURL = "/admin/store/reports/daily_sale/chart";
        ...
        function renderDiagram()
        {
            ...
            $('#daily_sale').html('');
            Highcharts.chart('daily_sale', option);
        }
