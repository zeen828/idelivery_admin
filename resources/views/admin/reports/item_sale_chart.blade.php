<div class="box">
    ...
    <div class="box-body table-responsive no-padding" style="border-top: 1px solid #f4f4f4;">
        <div id="item_sale" style="min-width: 250px; height: 400px; margin: 0 auto; padding: 10px;"></div>
    </div>
...
<script>
    ...
    $( document ).ready(function() {
        var chartData = null;
        var chartURL = "/admin/store/reports/item_sale/chart";
        ...
        function renderDiagram()
        {
            ...
            $('#item_sale').html('');
            Highcharts.chart('item_sale', option);
        }
