...
class Amount4CheckoutDiscountController extends Controller
{
    use ModelForm;
    ...
    public function index(Request $request)
    {
        ...
        return Admin::content(function (Content $content) {
            $content->header(trans('campaign.amount.discount.header'));
    ...
    protected function grid()
    {
        return Admin::grid(Campaign_setting_form::class, function (Grid $grid) {
            ...
            $grid->column(trans('campaign.amount.discount.offer_value'))->display(function() {
                return (int) $this->offer_discount->value.' %';
            });
    ...
    protected function form()
    {
        return Admin::form(Campaign_setting_form::class, function (Form $form) {
            ...
            $form->tab(trans('campaign.setting_tab'), function($form) {
                ...
                $form->rate('offer_discount.value', trans('campaign.amount.discount.offer_value'))
                    ->default(0)
