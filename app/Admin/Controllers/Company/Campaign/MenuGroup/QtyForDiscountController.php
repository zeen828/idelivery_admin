...
class QtyForDiscountController extends Controller
{
    use ModelForm;
    ...
    public function index(Request $request)
    {
        ...
        return Admin::content(function (Content $content) {
            $content->header('系列商品買滿Ｎ件/系列商品合計金額折Ｍ折');
    ...
    protected function grid()
    {
        return Admin::grid(Campaign_setting_form::class, function (Grid $grid) {
            ...
            $grid->column(trans('campaign.qty.discount_item_group.offer_value'))->display(function() {
                return (int) $this->offer_discount_menu_group->value.' %';
            });
    ...
    protected function form()
    {
        return Admin::form(Campaign_setting_form::class, function (Form $form) {
            ...
            $form->tab(trans('campaign.setting_tab'), function($form) {
                ...
                $form->rate('offer_discount_menu_group.value', trans('campaign.qty.discount_item_group.offer_value'))
                    ->default(0)
            ...
            $form->saved(function (Form $form) {
                ...
                $campaign_setting = Campaign_setting_form::find($id);
                $campaign_setting->offer_discount_menu_group->menu_item_ids = $campaign_setting->condition_qty_menu_group->menu_item_ids;
                $campaign_setting->offer_discount_menu_group->save();
