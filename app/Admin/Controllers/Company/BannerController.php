...
class BannerController extends Controller
{
    ...
    protected function grid()
    {
        return Admin::grid(News::class, function (Grid $grid) {
            ...
            $grid->model()->where('company_id', '=', Session::get('company_id'))->where('type', '=', 2);
    ...
    protected function form()
    {
        return Admin::form(News::class, function (Form $form) {
            ...
            $form->image('image', '上傳圖片')->uniqueName()->rules('required|max:900')
                ->move(env('ADMIN_UPLOAD_PATH', '') . 'company/image/banner/'.$company_id);
