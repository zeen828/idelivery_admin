...
class CouponCashAmountController extends Controller
{
    use ModelForm;
    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->header(trans('coupon.cash.amount.header'));
    ...
    public function edit($id)
    {
        ...
        return Admin::content(function (Content $content) use ($id) {
            ...
            $exec = false;
            if (!empty($setting) && !empty($setting->company_id)) {
                if ($company_id == $setting->company_id && $setting->store_id == 0) {
                    $exec = true;
                }
            }
    ...
    protected function grid()
    {
        return Admin::grid(Campaign_setting_form::class, function (Grid $grid) {
            ...
            $grid->offer_amount()->value(trans('coupon.cash.amount.offer_value'));
    ...
    protected function form()
    {
        return Admin::form(Campaign_setting_form::class, function (Form $form) {
            ...
            $form->tab(trans('coupon.setting_tab'), function($form) {
                ...
                $form->text("offer_amount.value", trans('coupon.cash.amount.offer_value'))
                    ->default(0)
                    ->rules('required|min:0')
