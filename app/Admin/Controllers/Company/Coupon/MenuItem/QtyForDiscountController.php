<?php
// 那些商品滿多少數量-指定商品合計金額打折
namespace App\Admin\Controllers\Company\Coupon\MenuItem;
...
class QtyForDiscountController extends Controller
{
    ...
    protected function grid()
    {
        return Admin::grid(Campaign_setting_form::class, function (Grid $grid) {
            ...
            $grid->model()
                ...
                ->where('offer_table', 'Offer_discount_menu_item');
            ...
            $grid->column(trans('campaign.qty.discount_item_group.offer_value'))->display(function() {
                return (int) $this->offer_discount_menu_item->value.' %';
            });
    ...
    protected function form()
    {
        return Admin::form(Campaign_setting_form::class, function (Form $form) {
            ...
            $form->hidden('offer_table')->default('Offer_discount_menu_item');
            ...
            $form->tab(trans('campaign.setting_tab'), function($form) {
                ...
                $form->rate('offer_discount_menu_item.value', trans('campaign.qty.discount_item_group.offer_value'))
                    ->default(0)
