...
class CouponItemItemController extends Controller
{
    use ModelForm;
    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->header(trans('coupon.item.qty.header'));
    ...
    protected function grid()
    {
        return Admin::grid(Campaign_setting_form::class, function (Grid $grid) {
            ...
            $grid->offer_menu_item()->value(trans('coupon.item.qty.offer_value'));
    ...
    protected function form()
    {
        return Admin::form(Campaign_setting_form::class, function (Form $form) {
            ...
            $form->tab(trans('coupon.setting_tab'), function($form) {
                ...
                $form->text("offer_menu_item.value", trans('coupon.item.qty.offer_value'))
                    ->default(0)
                    ->rules('required|min:0')
                    ->attribute('id', 'offer_value')
                    ->attribute('style', 'width:150px;');
                $form->text("offer_menu_item.max_value", trans('coupon.field.offer_max_value'))
                    ->default(0)
                    ->rules('required|min:0')
