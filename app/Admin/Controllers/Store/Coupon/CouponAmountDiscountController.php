...
class CouponAmountDiscountController extends Controller
{
    use ModelForm;
    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->header(trans('coupon.amount.discount.header'));
    ...
    public function edit($id)
    {
        ...
        return Admin::content(function (Content $content) use ($id) {
            ...
            if (empty($setting) || empty($setting->store_id)
    ...
    protected function grid()
    {
        return Admin::grid(Campaign_setting_form::class, function (Grid $grid) {
            $grid->model()->where('types', 2)
                ...
                ->where('store_id', '=', Session::get('company_id'))
            ...
            $grid->condition_amount()->value(trans('coupon.amount.cond_value'));
            $grid->offer_discount()->value(trans('coupon.amount.amount.offer_value'));
        ...
        return Admin::form(Campaign_setting_form::class, function (Form $form) {
            ...
            $form->tab(trans('coupon.setting_tab'), function($form) {
                ...
                $form->radio("product_delivery", trans('coupon.field.product_delivery'))
                    ...
                    ->default(0);
                $form->text("condition_amount.value", trans('coupon.amount.cond_value'))
                    ->default(0)
                    ->rules('required|min:0')
                    //->attribute('style', 'width:150px;')
                ...
                $form->rate("offer_discount.value", trans('coupon.amount.discount.offer_value'))
