...
class DiscountForQtyController extends Controller
{
    use ModelForm;
    ...
    public function index(Request $request)
    {
        ...
        return Admin::content(function (Content $content) {
            $content->header(trans('campaign.qty.discount.header'));
    ...
    protected function grid()
    {
        return Admin::grid(Campaign_setting_form::class, function (Grid $grid) {
            ...
            $grid->offer_discount()->value(trans('campaign.qty.amount.offer_value'));
    ...
    protected function form()
    {
        return Admin::form(Campaign_setting_form::class, function (Form $form) {
            ...
            $form->tab(trans('campaign.setting_tab'), function($form) {
                ...
                $form->rate("offer_discount.value", trans('campaign.qty.discount.offer_value'))
                    ->rules('required | between:1,99.99',['regex' => trans('campaign.qty.discount.offer_value').'必須是數字'])
                    ->default(0)
