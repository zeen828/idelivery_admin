...
class ExchangesController extends Controller
{
    ...
    public function guide()
    {
        return Admin::content(function (Content $content) {
            ...
            $msg   = '範例';
            $rows  = [
                ["condition" => "實體商品", "offer" => "-", "url" => route('store.exchanges.item.index'), "example" => "使用100點換泰迪熊"],
                ["condition" => "優惠券", "offer" => "-", "url" => route('store.exchanges.coupon.index'), "example" => "使用100點換9折折價券"],
            ];
            $style = 'success';
